...
class RecordPaymentUsecase {
    ...
    execute(request, context) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return Either_1.left(this.newUnexpectedError(e, request.invoiceId));
            }
        });
    }
    validateRequest(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!request.datePaid) {
                return Either_1.left(new Errors.PaymentDateRequiredError());
            }
    ...
    attachInvoice(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(request.invoiceId)
                ...
                .map((invoice) => (Object.assign({}, request, { invoice })))
                .execute();
        });
    }
    attachInvoiceItems(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(request.invoice.id.toString())
                ...
                return Object.assign({}, request, { invoiceItems: items });
            })
                .execute();
        });
    }
    attachExistingPayments(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(request.invoiceId)
                .then((invoiceId) => usecase.execute({ invoiceId }, context))
                .map((existingPayments) => (Object.assign({}, request, { existingPayments })))
                .execute();
        });
    }
    shouldPayInvoice(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (invoice.status === Invoice_1.InvoiceStatus.DRAFT) {
                return Either_1.left(new Errors.InvoiceCannotBePaidError(invoiceId));
            }
            if (invoice.status !== Invoice_1.InvoiceStatus.ACTIVE) {
                return Either_1.left(new Errors.InvoiceAlreadyPaidError(invoice.persistentReferenceNumber));
            }
            if (existingPayments.some((p) => p.status === Payment_1.PaymentStatus.PENDING)) {
                return Either_1.left(new Errors.PaymentPendingError(invoiceId));
            }
    ...
    attachPayer(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(request.invoiceId)
                .then((invoiceId) => usecase.execute({ invoiceId }, context))
                .map((payer) => (Object.assign({}, request, { payer })))
                .execute();
        });
    }
    attachManuscript(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(request.invoiceId)
                ...
                .map((manuscript) => (Object.assign({}, request, { manuscript })))
                .execute();
        });
    }
    attachStrategy(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Either_1.right(Object.assign({}, request, { strategy }));
        });
    }
    pay(request) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new AsyncEither_1.AsyncEither(makePaymentData)
                ...
                .map((paymentDetails) => (Object.assign({}, request, { paymentDetails })))
                .execute();
        });
    }
    //
    ...
    attachPaymentIfExists(context) {
        ...
        return (request) => __awaiter(this, void 0, void 0, function* () {
            return new AsyncEither_1.AsyncEither(request.invoiceId)
                ...
                .map((existingPayment) => (Object.assign({}, request, { existingPayment })))
                .execute();
        });
    }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (maybeUpdated.isLeft()) {
                    return Either_1.left(new AppError_1.UnexpectedError(new Error(maybeUpdated.value.message)));
                }
                ...
                return Either_1.right(updated);
            }
            catch (err) {
                return Either_1.left(new Errors.PaymentUpdateDbError(request.payment.invoiceId.toString(), err));
            }
        });
    }
    savePayment(context) {
        return (request) => __awaiter(this, void 0, void 0, function* () {
            ...
            const maybeCreateNewPayment = yield maybeWithPayment
                ...
                .map((payment) => (Object.assign({}, request, { payment })))
                .execute();
            const maybeUpdatePayment = yield maybeWithPayment
                ...
                return Object.assign({}, request, { payment: existingPayment });
            })
                .then(this.updatePayment)
                .map((payment) => (Object.assign({}, request, { payment })))
                .execute();
            return AsyncEither_1.flattenEither([maybeCreateNewPayment, maybeUpdatePayment]).map(([saveValue, updateValue]) => {
