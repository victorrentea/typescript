...
// export class Try<T> {
//   private constructor(public readonly data: T,public readonly error: Error) {
//   }
//   public static success<U>(data: U):Try<U> {
//     return new Try(data, null);
//   }
//   public static error<U>(error: Error):Try<U> {
...
//       const usecase = new GetInvoiceDetailsUsecase(this.invoiceRepo/*, username*/);
//
